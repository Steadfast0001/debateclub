...
const translations = {
  en: {
    clubName: "BIAKA Debate Club", schoolName: "BIAKA University Institute of Buea", menuLabel: "Menu", navHome: "Home", navAbout: "About", navRegister: "Register", navNews: "News", navContact: "Contact",
    ...
    aboutEyebrow: "About the club", aboutTitle: "Administrative team and club identity", aboutClubTitle: "What the club does", aboutClubText: "The BIAKA Debate Club creates a structured space where students learn to think quickly, research deeply, speak clearly and listen with maturity. Members participate in debates, mock panels, leadership forums, public speaking practice and campus events.",
    ...
    contactEyebrow: "Contact", contactTitle: "Reach the club and the school", clubContacts: "Club Contacts", schoolContacts: "School Contact", schoolAddress: "Bokoko, Biaka Street, Buea, South West Region, Cameroon", schoolWebsite: "School Website", socialMedia: "Social Media", footerText: "BIAKA Debate Club - Built for student leadership, civic reasoning and public speaking.",
    registered: "Registration submitted successfully.", noRegistrations: "No registrations yet."
  },
  fr: {
    clubName: "Club de Debat BIAKA", schoolName: "Institut Universitaire BIAKA de Buea", menuLabel: "Menu", navHome: "Accueil", navAbout: "A propos", navRegister: "Inscription", navNews: "Actualites", navContact: "Contact",
...
const leaders = [
  ...
  { role: "Vice President", roleFr: "Vice-presidente", name: "Daniel Ebot", phone: "+237 675 200 202", email: "vp@biakadebate.club", photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=900&q=80" },
